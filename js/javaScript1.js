...
window.drupalTranslations = {"strings":{"":{"Reset":"Reset","All":"All","Apply":"Apply","Archive":"Archive","Home":"Home","May":"May","Customer needs":"Customer needs","Filter by:":"Filter by:","Explore this story":"Explore this story","User manual":"User manual","(Online format)":"(Online format)","Read manual":"Read manual","Show more customer stories":"Show more customer stories","Segment":"Segment","Sub-segment":"Sub-segment","Country":"Country","No results found.":"No results found.","Clear filters":"Clear filters","Search for customer stories":"Search for customer stories","customer stories found":"customer stories found","Search for white papers...":"Search for white papers..."}},"pluralFormula":{"0":0,"1":0,"default":1}};;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
...
;
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports):"function"==typeof define&&define.amd?define(["exports"],t):t((e=e||self).all={})}(this,function(e){"use strict";function t(e){var r=e.querySelectorAll(".carousel__thumb"),i=e.querySelectorAll(".carousel__main-item");r.forEach(function(e,n){e.addEventListener("click",function(e){var o,t;e.preventDefault(),o=n,t=i,r.forEach(function(e,t){t===o?e.classList.add("carousel__thumb--active"):e.classList.remove("carousel__thumb--active")}),t.forEach(function(e,t){t===o?e.classList.add("carousel__main-item--active"):e.classList.remove("carousel__main-item--active")})})})}window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach);var m="sticky-menu--sticky-top",v="sticky-menu--sticky-fixed-top",p="sticky-menu--sticky-bottom",h="sticky-menu__link--active",y="sticky-menu__item--active",u="sticky-menu__overlay-hidden",d=0,L={FIXED_TOP:"fixed top",ABSOLUTE_TOP:"absolute top",ABSOLUTE_BOTTOM:"absolute bottom"};function g(e){return/^#/.test(e.hash)&&e.pathname===window.location.pathname}function i(e,t,o,n,r){var i,c,l,s,a,u=t.getBoundingClientRect(),d=u.top,f=u.bottom-e.offsetHeight;!function(e,t,o){switch(t){case L.FIXED_TOP:e.classList.add(v),e.classList.remove(m),e.classList.remove(p),e.style.top="".concat(o,"px");break;case L.ABSOLUTE_BOTTOM:e.classList.remove(v),e.classList.remove(m),e.classList.add(p),e.style.top=null;break;case L.ABSOLUTE_TOP:default:e.classList.remove(v),e.classList.remove(p),e.classList.add(m),e.style.top=0}}(e,(i=f,d-(c=r)<=0&&0<i-c?L.FIXED_TOP:i-c<=0?L.ABSOLUTE_BOTTOM:L.ABSOLUTE_TOP),r),l=o,s=n,a=e.getBoundingClientRect().bottom,l.forEach(function(e){var t,o,n;g(e)&&(o=(t=document.querySelector(e.hash).getBoundingClientRect()).top,n=t.bottom,o=Math.floor(o),n=Math.floor(n),o<=a&&a<n?(e.classList.add(h),e.parentNode.classList.add(y),s.innerHTML=e.innerHTML):(e.parentNode.classList.remove(y),e.classList.remove(h)))})}function o(t,o){var l=t.querySelector(".sticky-menu__current"),n=l.querySelector(".sticky-menu__current-active"),s=t.querySelector(".sticky-menu__list"),a=o.querySelector(".sticky-menu__overlay");l.addEventListener("click",function(){s.classList.toggle("sticky-menu__list--visible"),l.classList.toggle("sticky-menu__current--open"),a.classList.toggle(u)});var r=s.querySelectorAll("a");return r.forEach(function(e){e.addEventListener("click",function(e){var t,o,n,r,i,c;t=e,o=s,n=l,r=a,window.scrollTo&&g(t.currentTarget)&&(t.preventDefault(),i=t.currentTarget.hash,c=document.querySelector(i).getBoundingClientRect().top+window.pageYOffset-d,window.scrollTo(0,c),window.history.replaceState(void 0,"",i)),o.classList.remove("sticky-menu__list--visible"),n.classList.remove("sticky-menu__current--open"),r.classList.add(u)})}),i(t,o,r,n,d),window.addEventListener("scroll",function(){i(t,o,r,n,d)}),{setOffset:function(e){i(t,o,r,n,d=e)}}}function c(e,t){var o=e.querySelectorAll("a, button, video, input");if(o)if(t)for(var n=0;n<o.length;n+=1)o[n].removeAttribute("tabindex");else for(var r=0;r<o.length;r+=1){o[r].getBoundingClientRect().bottom+window.pageYOffset<e.getBoundingClientRect().bottom+window.pageYOffset?o[r].removeAttribute("tabindex"):o[r].setAttribute("tabindex","-1")}}function n(e){var t,r,i,o;e.getAttribute("data-show-expanded")||(t=e.querySelector(".show-more__checkbox"),r=e.querySelector(".show-more__toggle"),(i=e.querySelector(".show-more__outer")).classList.remove("show-more--no-js"),window.addEventListener("pageshow",function(){t.checked&&i.classList.add("show-more--nomax")}),i.addEventListener("scroll",function(e){e.target.scrollTop=0}),o=350,window.matchMedia("(prefers-reduced-motion: reduce)").matches&&(o=0),c(i,!1),t.addEventListener("change",function(e){var n;e.target.checked?(i.style.maxHeight="".concat(i.scrollHeight,"px"),setTimeout(function(){c(i,!0),i.style.removeProperty("max-height"),i.classList.add("show-more--nomax")},o)):(i.style.maxHeight="".concat(i.scrollHeight,"px"),i.classList.remove("show-more--nomax"),n=r.getBoundingClientRect().top,setTimeout(function(){c(i,!1),i.style.removeProperty("max-height")},10),setTimeout(function(){var e,t,o=r.getBoundingClientRect().top;o<0&&(t=0<(e=window.pageYOffset)+o-n?e+o-n:0,window.scrollTo(0,Math.round(t))),c(i,!1)},o+60))}))}function r(e,t){t.addEventListener("click",function(){document.addEventListener("keydown",function e(t){27===t.keyCode&&(window.location="#close",document.removeEventListener("keydown",e))})})}function s(e,t,o,n,r){var i=e.getBoundingClientRect().right,c=e.getBoundingClientRect().left,l=t.getBoundingClientRect().right,s=t.getBoundingClientRect().left;i<l?(e.classList.add("table-comp__outer-fade"),o.classList.add("scroll-arrow--visible")):(e.classList.remove("table-comp__outer-fade"),o.classList.remove("scroll-arrow--visible")),s<c?n.classList.add("scroll-arrow--visible"):n.classList.remove("scroll-arrow--visible"),"resize"!==r&&"first"!==r||function(e){var t=e.querySelectorAll("thead th");t.forEach(function(e){e.style.height=null});var o=t[0].offsetHeight;t.forEach(function(e){e.style.height="".concat(o,"px")})}(t)}function l(e){var t,o,n=e.querySelector(".table-comp__inner"),r=n.querySelector(".table-comp"),i=e.querySelector(".scroll-right-arrow"),c=e.querySelector(".scroll-left-arrow"),l=n.querySelector(".table__row-header").offsetWidth;n.style.scrollPaddingLeft="".concat(l,"px"),n.classList.add("table-comp__inner--smooth-scroll"),s(e,r,i,c,"first"),n.addEventListener("scroll",function(){window.clearTimeout(t),t=setTimeout(function(){s(e,r,i,c,"scroll")},50)}),i.addEventListener("click",function(){n.scrollLeft+=168}),c.addEventListener("click",function(){n.scrollLeft-=168}),window.addEventListener("resize",function(){clearTimeout(o),o=setTimeout(function(){s(e,r,i,c,"resize")},150)})}function a(e){e.target.parentNode.classList.add("active")}function f(e){var t=e.target;"SELECT"===t.tagName?t.options[t.selectedIndex].text||t.parentNode.classList.remove("active"):t.value||t.parentNode.classList.remove("active")}function _(e){e.querySelectorAll(".form-item--float").forEach(function(e){var t,o=e.querySelector("input, textarea, select");o&&("SELECT"===o.tagName?o.options[o.selectedIndex].text?e.classList.add("active"):e.classList.remove("active"):o.value?e.classList.add("active"):e.classList.remove("active"),(t=e.querySelector("input, textarea, select")).addEventListener("focus",a),t.addEventListener("blur",f))})}function w(e,t,o,n,r){var i=e.getBoundingClientRect().left,c=e.getBoundingClientRect().right,l=n[0].getBoundingClientRect().left,s=n[n.length-1].getBoundingClientRect().right,a=n[0].getBoundingClientRect().width;return n.forEach(function(e,t){10<e.getBoundingClientRect().left&&e.getBoundingClientRect().left<14?r[t].classList.add("active"):r[t].classList.remove("active")}),Math.round(s)>Math.round(c)+1?o.classList.add("scroll-arrow--visible"):o.classList.remove("scroll-arrow--visible"),Math.round(l)<Math.round(i)?t.classList.add("scroll-arrow--visible"):t.classList.remove("scroll-arrow--visible"),a}function E(e){var t,o="left"===e?(t="scroll-left-arrow","Scroll left"):(t="scroll-right-arrow","Scroll right"),n=document.createElement("button");return n.setAttribute("class",t),n.innerHTML=o,n}function b(e){var t=e.querySelector(".spot-img__coll"),o=t.querySelectorAll(".spot-img-card"),n=E("left"),r=E("right");e.appendChild(n),e.appendChild(r);var i,c,l=function(e,t){var o=document.createElement("div");o.setAttribute("class","row spot-img__coll-carousel-mobile-nav");var n=document.createElement("div");n.setAttribute("class","col-xs-12");var r=document.createElement("ul"),i=[];return t.forEach(function(e,t){var o=document.createElement("li"),n=document.createElement("a");n.innerHTML=t+1,n.addEventListener("click",function(){e.scrollIntoView()}),o.appendChild(n),r.appendChild(o),i.push(n)}),n.appendChild(r),o.appendChild(n),e.parentNode.insertBefore(o,e.nextSibling),i}(t,o),s=w(t,n,r,o,l);t.addEventListener("scroll",function(){window.clearTimeout(i),i=setTimeout(function(){s=w(t,n,r,o,l)},50)}),window.addEventListener("resize",function(){clearTimeout(c),c=setTimeout(function(){s=w(t,n,r,o,l)},150)}),r.addEventListener("click",function(){t.scrollLeft+=s}),n.addEventListener("click",function(){t.scrollLeft-=s})}function T(e,t){t&&e&&0<e?t.setAttribute("style","display: flex"):t.setAttribute("style","display: none")}function k(e){var t=e.closest(".filter-list").querySelector(".filter-list__checked-counter"),o=Array.prototype.slice.call(e.closest(".filter-list__list-items").querySelectorAll('input[type="checkbox"]')).filter(function(e){return!0===e.checked}).length;t&&(t.innerHTML=o),T(o,t)}function S(e){var t=e.querySelectorAll(".filter-list__checked-counter"),o=e.querySelectorAll('input[type="checkbox"]'),n=e.querySelector(".filter-list__clear-filters");o&&(Array.prototype.forEach.call(o,function(e){e.addEventListener("change",function(){k(e)}),k(e)}),n&&n.addEventListener("click",function(e){e.preventDefault(),Array.prototype.forEach.call(o,function(e){e.checked=!1}),Array.prototype.forEach.call(t,function(e){T(e.innerHTML=0,e)})}))}Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector),Element.prototype.closest||(Element.prototype.closest=function(e){var t=this;do{if(Element.prototype.matches.call(t,e))return t;t=t.parentElement||t.parentNode}while(null!==t&&1===t.nodeType);return null}),window.Axiscom={carousel:t,stickyMenu:o,showMore:n,modal:r,compTable:l,form:_,spotlightCardCarousel:b,filterListHandler:S},e.carousel=t,e.compTable=l,e.filterListHandler=S,e.form=_,e.modal=r,e.showMore=n,e.spotlightCardCarousel=b,e.stickyMenu=o,Object.defineProperty(e,"__esModule",{value:!0})});
